...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary brand colors - Soft pink tones
        brand: {
          50: "#FDF2F8",
          100: "#FCE7F3",
          200: "#FBCFE8",
      ...
      boxShadow: {
        ...
        "glow-lg": "0 0 60px -15px rgba(236, 72, 153, 0.4)",
      ...
      keyframes: {
        ...
        pulseGlow: {
          "0%, 100%": { boxShadow: "0 0 20px -5px rgba(236, 72, 153, 0.3)" },
          "50%": { boxShadow: "0 0 40px -5px rgba(236, 72, 153, 0.5)" },
        },
        float: {
