...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const successId = success && id ? `${id}-success` : undefined;
    ...
    return (
      <div className="relative">
        ...
        {error && (
          <p
            id={errorId}
            className="mt-2 text-sm text-error-600 flex items-center gap-1.5"
            role="alert"
          >
        ...
        {success && (
          <p
            id={successId}
            className="mt-2 text-sm text-success-600 flex items-center gap-1.5"
          >
